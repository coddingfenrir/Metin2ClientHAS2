...
void CPythonPlayer::__OnPressSmart(CInstanceBase& rkInstMain, bool isAuto)
{
	...
	const bool isPickedItemID=__GetPickedItemID(&dwPickedItemID);
	const bool isPickedActorID=__GetPickedActorID(&dwPickedActorID);
	const bool isPickedGroundPos=__GetPickedGroundPos(&kPPosPickedGround);
