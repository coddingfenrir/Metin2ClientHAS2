...
void CInstanceBase::AttachTextTail()
{
	...
	if (m_dwLevel)
		...
		UpdateTextTailFlag(m_stCountryName);
#endif
}
...
#if defined(__BL_MULTI_LANGUAGE_PREMIUM__)
void CInstanceBase::UpdateTextTailFlag(const std::string& countryName)
{
	CPythonTextTail::Instance().AttachFlag(GetVirtualID(), countryName);
}
#endif
